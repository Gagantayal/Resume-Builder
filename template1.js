module.exports = ({
    ...
    user.experience.forEach(element => {
        ...
        <div>
            <h3 class="float-left text-secondary">• </h3> <h3 class="ps-3 text-secondary">${element.jobtitle}</h3>
            <p class="m-0 ps-3">${element.projectname} • ${element.startm} ${element.starty}  ${element.endm} ${element.endy }</p>
    ...
    user.education.forEach(element => {
        ...
        <div>
            <h3 class="float-left text-secondary">• </h3> <h3 class="ps-3 text-secondary">${element.school}</h3>
            <p class="m-0 ps-3">${element.degree} • ${element.field} </p>
            <p class="ps-3">${element.syear} - ${element.gyear}</p>
        </div>
  ...
  <head>
    ...
    <body>
        <div>
            ...
            <div class="px-4">
                <h2 class="mx-4 font-bold mt-4">${user.firstname + " " + user.lastname } </h2>
                <p class="mx-4 fs-small mb-2 text-secondary">${user.tagline}</p>
            </div>
            ...
            <div class="px-4">
                ...
                <div class="col-5 float-left bg-light p-4">
                    ...
                    <p class="m-0 mb-2">${user.jobtitle}</p>
                    <h4 class="m-0 text-secondary">Location:</h4>
                    <p class="m-0 mb-2">${user.city+" "+user.state}</p>
                    <h4 class="m-0 text-secondary">Contact:</h4>
                    <p class="m-0 mb-2">${user.number}</p>
